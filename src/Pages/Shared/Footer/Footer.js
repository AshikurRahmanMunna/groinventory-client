        ...
        <div className="row py-5 row-cols-lg-3 row-cols-sm-6 row-cols-12">
          ...
          <div className="col footer-contact text-muted">
            ...
            <ul className="p-0">
              ...
              <li>
                <a
                  href="https://www.google.com/maps/place/Mulibash+Bazar/@23.6371873,90.5059683,21z/data=!4m5!3m4!1s0x3755b1b4598dae09:0xca3ebf7605a5ae07!8m2!3d23.6372154!4d90.5060616"
                  target={"_blank"}
                  rel="noopener noreferrer"
                >
